...
<form method="post" action="https://eprofessor.azurewebsites.net/code/ProcessFormData.asp" name="frmHW" id="frmHW">
  ...
  <table width="100%" border="1" cellspacing="1" cellpadding="1">
    ...
    <tr bgcolor="#00FFFF">
      ...
      <td><input name="InstID" type="hidden" id="InstID" value="00617282" />Email:        <input type="text" name="email" id="email" size="25" maxlength="50" /> 
...
response.write( "<font color='red'>" &  "No email provided. You will not receive credit unless this page contains an email address! Please refer to the 'Summary of Steps' to complete your assignment correctly" & "</font>")
response.write("</br>")

end if

response.write("Page generated at " & now() & " GMT <p> </p>")
...
%>
  ...
  <p align="center">&nbsp;</p>
  <h2>Note: This  assignment is submitted from Professor Paulson's Azure website.</h2>
...
<p align="center">All hyperlinks in this document will open a new browser window or tab in order to preserve your work.</p>
  ...
  <hr />
<p>&nbsp;</p>
<h1 align="center">External Monitor Setup-Optional to setup, but must answer question 1.</h1>
  <p align="left">&nbsp;</p>
  ...
  <br />
    ...
    Take a screen shot of both displays, save it as a graphics file (.jpg, .png or .gif are good- .bmp is bad).<br />
     optional, but recommend: Then upload this file to the D2L dropbox folder 'Homework01'</font></strong></p>
...
<p>&nbsp;</p>
  ...
  <p>ref: <a href="http://eprofessor.azurewebsites.net/BUSA353/Formative/Formative00/Formative00.asp#Exercise04">http://eprofessor.azurewebsites.net/BUSA353/Formative/Formative00/Formative00.asp#Exercise04 </a></p>
...
Also 
  ...
  <hr />
  <h1 align="center">&nbsp;</h1>
  <h1 align="center">View Class  Recordings Using Adobe Connect</h1>
  <p align="left">&nbsp;</p>
  <p align="left">    Read the  Recording instructions  so that you will know how to access the  class recordings.</p>
  <p align="left">Review this  Recording that has a title &quot;<a href="https://connect.shot.smsu.edu/p73xeeb5txw/">AppInventor-Sample</a>&quot;<br />
    Use the search function or view the recording to answer the following question:
    <br />
  </p>
  <p align="left">(10) 4. After logging into and viewing a recording you must take a screen shot of the Adobe Connect recording. <br>
Use the Snipping Tool to make a screen shot that includes the entire Adobe Connect application.<br>
<strong>Save the screen shot  as "Ex4_AdobeConnectRecording" as a   .gif, .png or .jpg file, and upload it to the Assignment00 Assignment folder in D2L.</strong></p>
  <hr />
  <h1 align="center"><a name="PrintToPDF" id="PrintToPDF"></a>Create PDF Files </h1>
  <p>Optional to Install <a href="../../CourseTechnology.htm#SoftwareInstalls">Adobe Acrobat Pro</a> from the control <a href="../../CourseTechnology.htm#SoftwareInstalls">panel</a>. <br>
  <strong>But you must answer Question 5 below.</strong></p>
